      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-100 flex items-center gap-3">
            <Icons.user className="w-8 h-8 text-blue-600 dark:text-blue-400" />
            Mi Perfil
          </h1>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setMostrarPasswordNuevo(!mostrarPasswordNuevo)
                    }
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-slate-300"
                  >
                ...
                {passwordNuevo && (
                  <div className="mt-3">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span
                        className={`text-sm font-medium ${fortaleza.color}`}
                      >
                        {fortaleza.texto}
                      </span>
                    </div>
